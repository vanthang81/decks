...
export const CHANGELOG: ChangeLog[] = [
  ...
  },
  {
    ...
    items: [
      'Sau khi ghi biên bản, mục “Biên bản & Quyết định” có nút “✉ Gửi biên bản” — gửi email nội dung biên bản + quyết định + danh sách hành động tới toàn bộ thành viên cuộc họp (chủ trì, thư ký, người tham gia).',
      'Trước khi gửi có cửa sổ xem trước người nhận + ô lời nhắn kèm theo; email trình bày chuyên nghiệp, có nút mở nhanh cuộc họp trên hệ thống.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      'Nhóm "Đã hoàn thành" mặc định thu gọn (bấm tiêu đề để mở/đóng, nhớ lựa chọn); mỗi nhóm sắp xếp việc theo HẠN gần nhất lên đầu; việc thuộc dự án hiện tên dự án kèm link mở nhanh dự án.',
    ],
  },
  {
    date: '09/09/2026 (Thêm NHIỀU việc cùng lúc vào dự án)',
    items: [
      'Modal "Thêm việc vào dự án" có công tắc "Một việc / Nhiều việc". Chế độ Nhiều việc: khai OKR/KR một lần dùng chung, rồi nhập loạt — mỗi dòng gồm tên · kết quả đầu ra (tuỳ chọn) · người giao · ưu tiên · hạn; gõ Enter hoặc dán nhiều dòng để thêm nhanh; lưu 1 lần tạo tất cả.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      'Nhật ký cập nhật chuyển sang trang riêng (/guide/changelog) để trang Hướng dẫn gọn, dễ theo dõi.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      '"Hướng dẫn" tách khỏi menu "Cá nhân" → thành mục menu ĐỘC LẬP có icon sách trên thanh trên cùng để mọi người dễ thấy.',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      'Ô chọn "Đơn vị" (thêm/sửa người dùng và mọi nơi chọn đơn vị): gõ tên KHỐI (vd "Tài chính") nay hiện ĐỦ mọi Phòng thuộc khối đó — trước đây chỉ ra phòng có tên chứa từ khoá. Mỗi phòng hiện thêm dòng nhỏ ghi rõ thuộc khối nào.',
    ],
  },
  {
