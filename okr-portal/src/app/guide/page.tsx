      ...
      <div className="wrap guide">
        ...
        <div className="guide-hero">
          ...
          <div style={{ marginTop: 12, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            ...
            <a className="btn sm" href="https://deck.consultx.vn/d/btmh-he-thong-quan-tri" target="_blank" rel="noopener noreferrer" title="Báo cáo Quản trị & Nhịp điều hành">
              📊 BCQT &amp; Nhịp điều hành (slide)
            </a>
          </div>
        </div>
