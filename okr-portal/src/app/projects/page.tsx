  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        {period && projects.length > 0 && <div data-tour="projects-list"><ProjectsList projects={projects} initialOwner={searchParams.owner} currentEmail={user.email} persistKey="projects-filters" /></div>}
